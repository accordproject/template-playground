  ...
  immer(
    devtools((set, get) => {
      ...
      return {
        ...
        originalTemplate: playground.TEMPLATE,
        editorValue: playground.TEMPLATE,
        modelCto: playground.MODEL,
        originalModel: playground.MODEL,
        ...
        loadSample: async (name: string) => {
          ...
          if (sample) {
            set(() => ({
              ...
              originalTemplate: sample.TEMPLATE,
              editorValue: sample.TEMPLATE,
              modelCto: sample.MODEL,
              originalModel: sample.MODEL,
        ...
        loadFromLink: async (compressedData: string) => {
          try {
            ...
            set(() => ({
              templateMarkdown,
              originalTemplate: templateMarkdown,
              editorValue: templateMarkdown,
              modelCto,
              originalModel: modelCto,
