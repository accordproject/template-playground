...
const MainContainer = () => {
  ...
  const executionResults = useAppStore((state) => state.executionResults);
            ...
            <Panel defaultSize={62.5} minSize={30}>
              ...
              >
                ...
                >
                      ...
                      >
                        ...
                        <div className="main-container-editor-header-left">
                          <button
                            ...
                            title={
                              isModelCollapsed
                                ? "Expand Data Model panel"
                                : "Collapse Data Model panel"
                            }
                            aria-label={
                              isModelCollapsed
                                ? "Expand Data Model panel"
                  ...
                  <Panel
                    minSize={3}
                    maxSize={isTemplateCollapsed ? collapsedSize : 100}
                    defaultSize={
                      isTemplateCollapsed ? collapsedSize : expandedSize
                    }
                  >
                        ...
                        >
                          <div className="main-container-editor-header-left">
                            <button
                              ...
                              title={
                                isTemplateCollapsed
                                  ? "Expand Template panel"
                                  : "Collapse Template panel"
                              }
                              aria-label={
                                isTemplateCollapsed
                                  ? "Expand Template panel"
                  ...
                  {Boolean(executionResults.response) && (
                    <>
                      <PanelResizeHandle className="main-container-panel-resize-handle-vertical" />
