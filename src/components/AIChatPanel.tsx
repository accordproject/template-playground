      ...
      <div className="w-full h-[calc(100%-3rem)] flex flex-col">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center justify-start px-2 gap-2">
            ...
            {/* TemplateMark Button */}
            <div
              className={`px-1 py-0.5 text-xs rounded-full flex items-center border transition-colors
            ...
            >
              ...
              {includeTemplateMarkContent && (
                <button
                  ...
                  onClick={() => handleTemplateMarkToggle(false)}
                  className={`ml-1 ${theme.contextButtons.templateMark.cross}`}
                  style={{
                    background: "none",
                    border: "none",
                    padding: 0,
            ...
            >
              ...
              {includeConcertoModelContent && (
                <button
                  ...
                  onClick={() => handleConcertoModelToggle(false)}
                  className={`ml-1 ${theme.contextButtons.concerto.cross}`}
                  style={{
                    background: "none",
                    border: "none",
                    padding: 0,
            ...
            >
              ...
              {includeDataContent && (
                <button
                  ...
                  className={`ml-1 ${theme.contextButtons.data.cross}`}
                  style={{
                    background: "none",
                    border: "none",
                    padding: 0,
