...
export const AIChatPanel = () => {
    ...
    return {
      ...
      contextButtons: {
        templateMark: {
          ...
          inactive: isDarkMode
            ? "bg-gray-700 text-gray-400 border-gray-600 line-through opacity-70 hover:bg-blue-900 hover:text-blue-300 hover:border-blue-700"
        ...
        concerto: {
          ...
          inactive: isDarkMode
            ? "bg-gray-700 text-gray-400 border-gray-600 line-through opacity-70 hover:bg-green-900 hover:text-green-300 hover:border-green-700"
        ...
        data: {
          ...
          inactive: isDarkMode
            ? "bg-gray-700 text-gray-400 border-gray-600 line-through opacity-70 hover:bg-yellow-900 hover:text-yellow-300 hover:border-yellow-700"
  ...
  const [includeTemplateMarkContent, setIncludeTemplateMarkContent] =
    useState<boolean>(localStorage.getItem("aiIncludeTemplateMark") === "true");
  const [includeConcertoModelContent, setIncludeConcertoModelContent] =
    useState<boolean>(
  ...
  const renderMessageContent = (content: string) => {
    ...
    if (!displayContent || !displayContent.includes("```")) {
      return (
        <div
          className={`text-sm prose prose-sm break-all max-w-none ${isError ? "text-red-700" : ""}`}
          style={isError ? {} : { color: textColor }}
        >
          <ReactMarkdown
            components={{
              code: ({ children, className }) => (
                <code
                  className={`${theme.inlineCode} p-1 rounded-md before:content-[''] after:content-[''] ${className ?? ""}`}
                >
                  {children}
                </code>
              ),
  ...
  useEffect(() => {
    if (chatState.messages.length > 0 && latestMessageRef.current) {
      const messageContainer =
        latestMessageRef.current.closest(".overflow-y-auto");
            ...
            {chatState.messages.length === 0 ? (
              <div className="w-full">
                <div className={`${theme.welcomeMessage} p-3 rounded-lg`}>
                  <p
                    className={`text-xs font-semibold mb-1 ${theme.welcomeText}`}
                  >
                    Assistant
                  </p>
                ...
                return (
                  <div
                    ...
                    ref={
                      ...
                      index === chatState.messages.length - 2
                        ? latestMessageRef
                        : null
                    }
                  >
                    ...
                    >
                      <p
                        ...
                        style={{ color: isError ? "#991b1b" : textColor }}
                      >
                      ...
                      {message.role === "assistant" &&
                        ...
                        chatState.isLoading && (
                          <p
                            className={`text-sm mt-2 italic ${theme.thinkingText}`}
                          >
                            Thinking...
                          </p>
                        )}
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center justify-start px-2 gap-2">
            ...
            <div
              ...
              className={`px-1 py-0.5 text-xs rounded-full flex items-center cursor-pointer border transition-colors
                  ${
          ...
          <div
            className={`flex gap-2 p-2 rounded-lg border ${theme.inputContainer}`}
          >
            <textarea
              ref={textareaRef}
              value={userInput}
            ...
            <div className="relative">
              ...
              {isDropdownOpen && !chatState.isLoading && (
                <div
                  className={`absolute bottom-full mb-1 right-0 w-48 rounded-lg shadow-lg border py-1 ${theme.dropdownMenu}`}
                >
                  <button
                    onClick={() => {
