...
export function tmNodeToTipTap(node: TemplateMarkNode): JSONContent | JSONContent[] | null {
  ...
  // Softbreak = single newline in markdown, renders as whitespace (text flows together)
  ...
  if (cls === 'org.accordproject.commonmark@0.5.0.Linebreak') {
...
export function tipTapNodeToTM(node: JSONContent): TemplateMarkNode | TemplateMarkNode[] | null {
  ...
  if (type === 'hardBreak') {
    return { $class: 'org.accordproject.commonmark@0.5.0.Linebreak' };
  }
